        ...
        try {
            ...
            if (learnerInfoData != null) {
            	if (learnerInfoData.length == 8) {
                     ...
                     *
                     * Reading:
                     *  LearnerInfo of current version
                     *
                     * */
                     ...
                     *
                     * Reading:
                     *  LearnerInfo of previous version
                     *
                     * */
            ...
            if (this.getVersion() < 0x10000) {
                 ...
                 *
                 * Reading:
                 *  Send LEADERINFO to all followers.
                 *  Process received ACKEPOCH
                 *
                 *
                 * */
                 ...
                 *
                 * Reading:
                 *  Finish the election when we has received ACKEPOCH from major of follower.
                 *  Throw exception when receives StateSummary which is more recent than mine.
                 *
                 * */
                leader.waitForEpochAck(this.getSid(), ss);
            }
             ...
             *
             * Reading:
             *  {@link ss} is the StateSummary of respective learner.
             *
             *
             *
             * */
            ...
            try {
                ...
                if (peerLastZxid == leader.zk.getZKDatabase().getDataTreeLastProcessedZxid()) {
                     ...
                     *
                     * Reading:
                     *  Follower has already sync with us.
                     *
                     *
                     * */
                    ...
                    if ((maxCommittedLog >= peerLastZxid)
                         ...
                         *
                         * Reading:
                         *  I have committed logs which learner has not.
                         *  So what I need to do is just send missing committed logs to learner.
                         *
                         * */
                         ...
                         *
                         * Reading:
                         *  Learner has receives logs that leader has not.
                         *
                         * */
             ...
             *
             * Reading:
             *  The server who is LEADING becomes leader iff after syncing with followers.
             *
             * */
