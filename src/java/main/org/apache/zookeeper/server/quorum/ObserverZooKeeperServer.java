...
public class ObserverZooKeeperServer extends LearnerZooKeeperServer {
    ...
    public void commitRequest(Request request) {
         ...
         *
         * Reading:
         *  Commit request to {@link CommitProcessor} and {@link CommitProcessor} will process it because {@link CommitProcessor} is a thread,
         *  and it will poll the {@link Request} infinitely.
         *
         *
         * */
    ...
    protected void setupRequestProcessors() {
         ...
         *
         * Reading:
         *  The chain of {@link RequestProcessor} is:
         *      {@link ObserverRequestProcessor} -> {@link CommitProcessor} -> {@link FinalRequestProcessor}
         *
         *
         * */
         ...
         *
         * Reading:
         *  Observer won't send back ACK when receives SYNC and INFORM, but follower does.
         *
         * */
    }
