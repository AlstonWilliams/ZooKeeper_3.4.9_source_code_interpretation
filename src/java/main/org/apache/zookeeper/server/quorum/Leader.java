...
public class Leader {
    ...
    public long getEpochToPropose(long sid, long lastAcceptedEpoch) throws InterruptedException, IOException {
        synchronized(connectingFollowers) {
             ...
             *
             * Reading:
             *  When all followers have sent their accepted epoch to leader, {@link waitingForNewEpoch} will be false.
             *
             * */
             ...
             *
             * Reading:
             *  Use the maximum epoch plus one as proposed epoch if you receives the epoch from the major of Follower
             *  But how can we guarantee this epoch is the maximum in all Follower?
             *
             * */
            if (connectingFollowers.contains(self.getId()) && 
                 ...
                 *
                 * Reading:
                 *  A leader must receive all LEADERINFO before timeout, otherwise I will throw an exception.
                 *
                 *
                 * */
                ...
                while(waitingForNewEpoch && cur < end) {
                     ...
                     * Reading:
                     *  So wonderful design!
                     *  This method is called by every {@link LearnerHandler} and is used to get the latest epoch from all followers.
                     *
                     *
                     * */
