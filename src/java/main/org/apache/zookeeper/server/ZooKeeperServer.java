...
public class ZooKeeperServer implements SessionExpirer, ServerStats.Provider {
    ...
    static {
        ...
        // Reading: Log the environment variable
    ...
    // Reading: Print the configuration
     ...
     */
    // Reading: Restore sessions and data when a new leader is elected
    ...
    // Reading: Produce snapshot from txnLogFactory
    ...
    // Reading: Be used to close the session not ZooKeeperServer instance
    ...
    // Reading: Add the session to sessionTracker
    ...
    // Reading: Initialize ZKDatabase and load data
    ...
    public void submitRequest(Request si) {
        /**
         * Reading:
         *  Wait for request processor chain be initialed
         *
         * */
        if (firstProcessor == null) {
            synchronized (this) {
    ...
    public void processConnectRequest(ServerCnxn cnxn, ByteBuffer incomingBuffer) throws IOException {
         ...
         *
         * Reading:
         *  This server is out of date. So choose a new server which has newer data.
         *
         * */
        ...
        if (sessionId != 0) {
             ...
             *
             * Reading:
             *  The client try to connect repeatedly.
             *
             * */
             ...
             *
             * Reading:
             *  The client try to connect first time.
             *
             * */
